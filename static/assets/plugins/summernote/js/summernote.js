        ...
        p = {
            ...
            options: {
                ...
                icons: {
                    ...
                    lists: {
                        unordered: "listing-box",
                        ordered: "listing-number"
                    },
                    options: {
                        help: "question",
                        fullscreen: "drag",
        ...
        N = function() {
            var b = function(a, b) {
                    var c = b.event,
                        ...
                        g = b.dropdown,
                        h = b.hide;
                    return (g ? '<div class="btn-group' + (f ? " " + f : "") + '">' : "") + '<button type="button" class="btn btn-primary btn-sm' + (!g && f ? " " + f : "") + (g ? " dropdown-toggle" : "") + '"' + (g ? ' data-toggle="dropdown"' : "") + (e ? ' title="' + e + '"' : "") + (c ? ' data-event="' + c + '"' : "") + (d ? " data-value='" + d + "'" : "") + (h ? " data-hide='" + h + "'" : "") + ' tabindex="-1">' + a + (g ? ' ' : "") + "</button>" + (g || "") + (g ? "</div>" : "")
                },
                c = function(a, c) {
                    var d = '<i class="' + a + '"></i>';
                    return b(d, c)
                ...
                v = {
                    ...
                    help: function(a, b) {
                        var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (i.isMac ? t(a, b) : u(t(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.16</a> Â· <a href="//github.com/summernote/summernote" target="_blank">Project</a> Â· <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
                ...
                y = function(a) {
                    return i.isMac && (a = a.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), a.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")
                },
                z = function(b, c, d) {
